...
def handle_button_click(update: Update, context: CallbackContext) -> None:
    ...
    if data.startswith("toggle_"):
        ...
        show_sanctions_section(update, context)
...
def show_sanctions_section(update: Update, context: CallbackContext) -> None:
...
def show_today(update: Update, context: CallbackContext) -> None:
